...
<html lang="en">
  <head>
    ...
    <title>BBQ Pork with Rice Noodles | Banh Mi Nen</title>
...
<hr>
<h2 class="text-center">BBQ Pork with Rice Noodles</h2>
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="images/menu/menu-item6/menu-item6.1.jpg" alt="BBQ Pork with Rice Noodles" width="460" height="345">
      </div>

      <div class="item">
        <img src="images/menu/menu-item6/menu-item6.3.JPG" alt="BBQ Pork with Rice Noodles" width="460" height="345">
      </div>
      <div class="item">
        <img src="images/menu/menu-item6/menu-item6.4.JPG" alt="BBQ Pork with Rice Noodles" width="460" height="345">
      </div>
    </div>
...
<div class="about-stretch">
 <p id="about-description">BBQ Pork with Rice Noodles</p>
</div>
