...
<html lang="en">
  <head>
    ...
    <title>Salmon Summer Rolls | Banh Mi Nen</title>
...
<hr>
<h2 class="text-center">Salmon Summer Rolls</h2>
<br>
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="images/menu/menu-item5/menu-item5.1.JPG" alt="Salmon Summer Rolls" width="460" height="345">
      </div>

      <div class="item">
        <img src="images/menu/menu-item5/menu-item5.3.JPG" alt="Salmon Summer Rolls" width="460" height="345">
      </div>  
      <div class="item">
        <img src="images/menu/menu-item5/menu-item5.4.JPG" alt="Salmon Summer Rolls" width="460" height="345">
      </div>    
    </div>
...
<div class="about-stretch">
 <p id="about-description">Salmon Summer Rolls</p>
</div>
  <!-- end of main body -->
