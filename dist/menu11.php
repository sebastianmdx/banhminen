...
<html lang="en">
  <head>
    ...
    <title>Lemongrass Tofu with Rice | Banh Mi Nen</title>
...
<hr>
<h2 class="text-center">Lemongrass Tofu with Rice</h2>
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="images/menu/menu-item11/menu-item11.1.JPG" alt="Lemongrass Tofu with Rice" width="460" height="345">
      </div>
      <div class="item">
        <img src="images/menu/menu-item11/menu-item11.3.JPG" alt="Lemongrass Tofu with Rice" width="460" height="345">
      </div>
      <div class="item">
        <img src="images/menu/menu-item11/menu-item11.4.JPG" alt="Lemongrass Tofu with Rice" width="460" height="345">
      </div>      
    </div>
...
<div class="about-stretch">
 <p id="about-description">Lemongrass Tofu with Rice</p>
</div>
  <!-- end of main body -->
