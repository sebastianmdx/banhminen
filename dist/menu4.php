...
<html lang="en">
  <head>
    ...
    <title>Tofu Summer Rolls | Banh Mi Nen</title>
...
<hr>
<h2 class="text-center">Tofu Summer Rolls</h2>
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      ...
      <div class="item active">
        <img src="images/menu/menu-item4/menu-item4.2.JPG" alt="Tofu Summer Rolls" width="460" height="345">
      </div>
    
      <div class="item">
        <img src="images/menu/menu-item4/menu-item4.3.JPG" alt="Tofu Summer Rolls" width="460" height="345">
      </div>

      <div class="item">
        <img src="images/menu/menu-item4/menu-item4.4.JPG" alt="Tofu Summer Rolls" width="460" height="345">
      </div>
    </div>
...
<div class="about-stretch">
 <p id="about-description">Tofu Summer Rolls</p>
</div>
