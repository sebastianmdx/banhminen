...
<html lang="en">
  <head>
    ...
    <title>Chicken Curry with Rice | Banh Mi Nen</title>
...
<hr>
<h2 class="text-center">Chicken Curry with Rice</h2>
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="images/menu/menu-item10/menu-item10.1.JPG" alt="Chicken Curry with Rice" width="460" height="345">
      </div>

      <div class="item">
        <img src="images/menu/menu-item10/menu-item10.2.JPG" alt="Chicken Curry with Rice" width="460" height="345">
      </div>
      <div class="item">
        <img src="images/menu/menu-item10/menu-item10.3.JPG" alt="Chicken Curry with Rice" width="460" height="345">
      </div>
      <div class="item">
        <img src="images/menu/menu-item10/menu-item10.4.JPG" alt="Chicken Curry with Rice" width="460" height="345">
      </div>      
    </div>
...
<div class="about-stretch">
 <p id="about-description">Chicken Curry with Rice</p>
</div>
  <!-- end of main body -->
