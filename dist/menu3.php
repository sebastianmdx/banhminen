...
<html lang="en">
  <head>
    ...
    <title> Fresh Summer Rolls | Banh Mi Nen</title>
...
<hr>
<h2 class="text-center">Fresh Summer Rolls</h2>
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="images/menu/menu-item3/menu-item3.1.JPG" alt="Fresh Summer Rolls" width="460" height="345">
      </div>
    
      <div class="item">
        <img src="images/menu/menu-item3/menu-item3.3.JPG" alt="Fresh Summer Rolls" width="460" height="345">
      </div>

      <div class="item">
        <img src="images/menu/menu-item3/menu-item3.4.JPG" alt="Fresh Summer Rolls" width="460" height="345">
      </div>
    </div>
...
<div class="about-stretch">
 <p id="about-description">Fresh Summer Rolls</p>
</div>
