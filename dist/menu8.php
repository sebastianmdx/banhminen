...
<html lang="en">
  <head>
    ...
    <title>BBQ Pork with Rice | Banh Mi Nen</title>
...
<hr>
<h2 class="text-center">BBQ Pork with Rice</h2>
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="images/menu/menu-item8/menu-item8.1.JPG" alt="BBQ Pork with Rice" width="460" height="345">
      </div>

      <div class="item">
        <img src="images/menu/menu-item8/menu-item8.2.JPG" alt="BBQ Pork with Rice" width="460" height="345">
      </div>
      <div class="item">
        <img src="images/menu/menu-item8/menu-item8.4.JPG" alt="BBQ Pork with Rice" width="460" height="345">
      </div>            
    </div>
...
<div class="about-stretch">
 <p id="about-description">BBQ Pork with Rice</p>
</div>
