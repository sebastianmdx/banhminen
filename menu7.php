...
<html lang="en">
  <head>
    ...
    <title>Chicken with Rice Noodles | Banh Mi Nen</title>
...
<hr>
<h2 class="text-center">Chicken with Rice Noodles</h2>
<br>
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="images/menu/menu-item7/menu-item7.1.JPG" alt="Chicken with Rice Noodles" width="460" height="345">
      </div>

      <div class="item">
        <img src="images/menu/menu-item7/menu-item7.2.JPG" alt="Chicken with Rice Noodles" width="460" height="345">
      </div>
    </div>
...
<div class="about-stretch">
 <p id="about-description">Chicken with Rice Noodles</p>
</div>
  <!-- end of main body -->
