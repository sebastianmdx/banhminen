...
<html lang="en">
  <head>
    ...
    <title>BBQ Pork Baguette | Banh Mi Nen</title>
...
<hr>
<h2 class="text-center">BBQ Pork Baguette</h2>
<br>
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="images/menu/menu-item1/menu-item1.1.png" alt="BBQ Pork Baguette" width="460" height="345">
      </div>
      <div class="item">
        <img src="images/menu/menu-item1/menu-item1.3.JPG" alt="BBQ Pork Baguette" width="460" height="345">
      </div>
    </div>
...
<div class="about-stretch">
 <p id="about-description">BBQ PORK BAGUETTE</p>
</div>
