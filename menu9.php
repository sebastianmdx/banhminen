...
<html lang="en">
  <head>
    ...
    <title>Lemongrass Chicken with Rice | Banh Mi Nen</title>
...
<hr>
<h2 class="text-center">Lemongrass Chicken with Rice</h2>
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="images/menu/menu-item9/menu-item9.1.JPG" alt="Lemongrass chicken with rice" width="460" height="345">
      </div>
      <div class="item">
        <img src="images/menu/menu-item9/menu-item9.2.JPG" alt="Lemongrass chicken with rice" width="460" height="345">
      </div>
      <div class="item">
        <img src="images/menu/menu-item9/menu-item9.4.JPG" alt="Lemongrass chicken with rice" width="460" height="345">
      </div>
    </div>
...
<div class="about-stretch">
 <p id="about-description">Lemongrass Chicken with Rice</p>
</div>
  <!-- end of main body -->
