...
<html lang="en">
  <head>
    ...
    <title>Chicken Baguette | Banh Mi Nen</title>
...
<hr>
<h2 class="text-center">Chicken Baguette</h2>
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="images/menu/menu-item2/menu-item2.1.JPG" alt="Chicken Baguette" width="460" height="345">
      </div>
    
      <div class="item">
        <img src="images/menu/menu-item2/menu-item2.3.JPG" alt="Chicken Baguette" width="460" height="345">
      </div>
    </div>
...
<div class="about-stretch">
 <p id="about-description">Chicken Baguette
 </p>
</div>
  <!-- end of main body -->
